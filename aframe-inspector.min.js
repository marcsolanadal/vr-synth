...
*/
  ...
  function (e, t, n) {
    ...
    function o(e, t) {
      if (
        ...
        (!0 === t ||
          confirm(
            "Do you really want to remove entity `" + (e.id || e.tagName) + "`?"
          ))
      ) {
        var n = a(e);
    ...
    function a(e) {
      for (var t = e.nextElementSibling; t && (!t.isEntity || t.isInspector); )
    ...
    function s(e, t) {
      t.parentNode || (t = AFRAME.INSPECTOR.selectedEntity),
        t
          ? t.parentNode.insertBefore(e, t.nextSibling)
          : AFRAME.INSPECTOR.sceneEl.appendChild(e);
    }
    function u(e) {
      e.flushToDOM();
      var t = e.cloneNode(!0);
    ...
    function p(e) {
      for (
        ...
        (a.nodeType === Node.ELEMENT_NODE &&
          (a.hasAttribute("aframe-injected") ||
            a.hasAttribute("data-aframe-inspector") ||
            a.hasAttribute("data-aframe-canvas"))) ||
          t.appendChild(p(n[r]));
      }
      return f(t, e), t;
    }
    ...
    function h(e, t) {
      function n() {
        var n = v(e, null, t);
        return (
          void 0 === n && (n = g(e, null, t)),
          void 0 !== n ? (o = !0) : (n = y(e, null, t)),
          void 0 !== n ? e.schema.parse(n) : n
        );
      }
      function r() {
        var n;
        return (
          Object.keys(e.schema).forEach(function (r) {
            var a = m(e, r, t);
            if (
              (void 0 === a && (a = v(e, r, t)),
              void 0 === a && (a = g(e, r, t)),
              void 0 !== a ? (o = o || !0) : (a = y(e, r, t)),
              void 0 !== a)
            ) {
    ...
    function v(e, t, n) {
      for (
        var r, o = n.mixinEls.reverse(), a = 0;
        void 0 === r && a < o.length;
        a++
      ) {
        var i = o[a];
        i.attributes.hasOwnProperty(e.name) &&
          (r = t ? i.getAttribute(e.name)[t] : i.getAttribute(e.name));
      }
      return r;
    }
    function g(e, t, n) {
    ...
    function x(e, t) {
      ...
      return (
        t +
        '="' +
        AFRAME.utils.styleParser.stringify(n).replace(/;|:/g, "$& ") +
        '"'
      );
    }
    function C(e, t) {
      ...
      return (
        e.isScene || o || !e.getAttribute("class")
          ? e.isScene ||
            ...
            ((o = e.getAttribute("mixin").split(" ")[0]), (a = "mixin"))
          : ((o = e.getAttribute("class").split(" ")[0]), (a = "class")),
        O.default.createElement(
          "span",
          { className: "entityPrint", onDoubleClick: t },
          O.default.createElement(
            "span",
          ...
          o &&
            O.default.createElement(
              "span",
              { className: "entityName", "data-entity-name-type": a },
              " ",
              o
            ),
          !!n &&
          ...
          O.default.createElement("span", { className: "entityCloseTag" }, ">")
        )
      );
    }
    function _(e, t) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.updateEntity = r),
      (t.removeEntity = o),
      (t.removeSelectedEntity = i),
      (t.cloneEntity = u),
      (t.cloneSelectedEntity = l),
      (t.getEntityClipboardRepresentation = c),
      (t.getComponentClipboardRepresentation = x),
      (t.printEntity = C),
      (t.createEntity = _);
    var T = n(1),
      O = (function (e) {
  ...
  function (e, t, n) {
    ...
    function o(e) {
      for (var t = e.split("."), n = !1, r = 0; r < t.length; r++)
        n ? (t[r] = 0) : "0" !== t[r] && (n = !0);
      return t.join(".");
    }
    function a(e, t) {
    ...
    function s(e) {
      ...
      (t.href = e),
        ...
        t.setAttribute("data-aframe-inspector", "style"),
    ...
    function u(e, t, n) {
      ...
      (r.src = e),
        (r.charset = "utf-8"),
        r.setAttribute("data-aframe-inspector", "style"),
        t && r.addEventListener("load", t),
        n && r.addEventListener("error", n),
        document.head.appendChild(r);
    }
    function l(e, t, n) {
      c(new Blob([e], { type: n }), t);
    }
    function c(e, t) {
...
*/
        ...
        function t(e) {
          ...
          return (
            (n.onMouseMove = function (e) {
              ...
              (a = Math.min(n.props.max, Math.max(n.props.min, a))),
                t !== a && n.setValue(a),
            ...
            (n.onMouseUp = function (e) {
              document.removeEventListener("mousemove", n.onMouseMove, !1),
                ...
                Math.abs(n.distance) < 2 &&
                  (n.refs.input.focus(), n.refs.input.select());
            }),
            (n.onBlur = function () {
              n.setValue(parseFloat(n.refs.input.value)),
                n.setState({ class: "" });
            }),
            ...
            (n.onKeyDown = function (e) {
              return (
                ...
                13 === e.keyCode
                  ? (n.setValue(parseFloat(n.refs.input.value)),
                    void n.refs.input.blur())
                  : 38 === e.keyCode
                  ? void n.setValue(parseFloat(n.state.value) + 0.01)
                  : 40 === e.keyCode
                  ? void n.setValue(parseFloat(n.state.value) - 0.01)
                  : void 0
              );
  ...
  function (e, t, n) {
    ...
    function o(e, t, n, o) {
      var a = [t, o];
      if (n && e)
        for (var i in n) n.hasOwnProperty(i) && n[i] && a.push("" + r(e, i));
      return a
        .filter(function (e) {
          return e;
        })
    ...
    function f(e, t) {
      ...
      r.bottom + o > n.bottom
        ...
        : r.top - o < n.top && u(e, Math.max(t.offsetTop - o, 0));
    }
    function d(e) {
    ...
    function m(e) {
      var t = e.maxHeight,
        ...
        f = c.spacing,
        d = l(n),
        h = { placement: "bottom", maxHeight: t };
      ...
      switch (o) {
        ...
        case "bottom":
          ...
          if (I >= b && !i)
            return a && p(d, M, 160), { placement: "bottom", maxHeight: t };
          if ((!i && I >= r) || (i && S >= r)) {
            a && p(d, M, 160);
            return { placement: "bottom", maxHeight: i ? S - T : I - T };
          }
          if ("auto" === o || i) {
            var P = t;
            return (
              ((!i && A >= r) || (i && k >= r)) &&
                (P = i ? k - T - f.controlHeight : A - T - f.controlHeight),
              { placement: "top", maxHeight: P }
            );
          }
          if ("bottom" === o)
            return u(d, M), { placement: "bottom", maxHeight: t };
          break;
        case "top":
          if (k >= b) return { placement: "top", maxHeight: t };
          if (A >= b && !i)
            return a && p(d, R, 160), { placement: "top", maxHeight: t };
          if ((!i && A >= r) || (i && k >= r)) {
            var N = t;
            return (
              ((!i && A >= r) || (i && k >= r)) && (N = i ? k - O : A - O),
              a && p(d, R, 160),
    ...
    function g(e, t) {
      ...
      if (
        ...
        for (n = r; 0 != n--; )
          if (!(("_owner" === (o = p[n]) && e.$$typeof) || g(e[o], t[o])))
            return !1;
        return !0;
      }
      return e !== e && t !== t;
    ...
    var F =
      ...
      q = function (e) {
        return Array.isArray(e)
          ? e.filter(Boolean)
          : "object" === (void 0 === e ? "undefined" : F(e)) && null !== e
          ? [e]
          : [];
      },
      X = function (e) {
      ...
      K = function (e) {
        ...
        return (
          (t = {}),
          H(t, v(n), "100%"),
          H(t, "backgroundColor", i.neutral0),
          H(t, "borderRadius", o),
          H(
            t,
            "boxShadow",
          ...
          H(t, "marginBottom", a.menuGutter),
          H(t, "marginTop", a.menuGutter),
          H(t, "position", "absolute"),
          H(t, "width", "100%"),
          H(t, "zIndex", 1),
          t
        );
    ...
    Z.contextTypes = { getPortalPlacement: M.a.func };
    var $ = function (e) {
        var t = e.children,
          r = e.className,
          o = e.cx,
          ...
          i = e.innerRef,
          s = e.innerProps,
          u = o(n.i(S.a)(a("menu", e)), { menu: !0 }, r);
        return k.a.createElement("div", U({ className: u }, s, { ref: i }), t);
      },
      Q = function (e) {
        var t = e.maxHeight,
    ...
    oe.defaultProps = { children: "Loading..." };
    var ae = function (e) {
        var t = e.rect,
          n = e.offset,
          r = e.position;
        ...
        function t() {
          ...
          return (
            ...
            (r.getPortalPlacement = function (e) {
              var t = e.placement;
              t !== X(r.props.menuPlacement) && r.setState({ placement: t });
            }),
            (o = n),
            z(r, o)
          );
    ...
    ie.childContextTypes = { getPortalPlacement: M.a.func };
    var se = Array.isArray,
      ...
      pe = function (e) {
        for (var t = 0; t < ce.length; t++)
          e = e.replace(ce[t].letters, ce[t].base);
        return e;
      },
      fe = function (e) {
          ...
          j(t, [
            {
              ...
              value: function () {
                ...
                if (Ee) {
                  ...
                  o &&
                    x() &&
                    (o.addEventListener("touchmove", b, this.listenerOptions),
                    r &&
                      (r.addEventListener(
                        "touchstart",
                        w,
    ...
    xe.defaultProps = { accountForScrollbars: !0 };
    var Ce = (function (e) {
        function t() {
          var e, n, r, o;
          L(this, t);
              ...
              value: function () {
                ...
                return r
                  ? k.a.createElement(
                      ...
                      o ? k.a.createElement(xe, { touchScrollTarget: o }) : null
                    )
                  : t;
              },
            },
    ...
    var Oe = function (e) {
      ...
      Fe = function (e) {
        ...
        return k.a.createElement(
          ...
          U(
            {
              className: o(
                n.i(S.a)(a("container", e)),
                { "--is-disabled": s, "--is-rtl": u },
                r
              ),
            },
            i
          ...
          j(t, [
            {
              ...
              value: function () {
                ...
                return k.a.createElement(
                  ...
                  {
                    className: o(
                      n.i(S.a)(i("valueContainer", this.props)),
                      {
                        "value-container": !0,
      ...
      Ue = function (e) {
        ...
        return k.a.createElement(
          ...
          {
            className: o(
              n.i(S.a)(a("indicatorsContainer", e)),
              { indicators: !0 },
              r
            ),
          },
    ...
    Ye.defaultProps = { children: k.a.createElement(ze, null) };
    var qe = We,
      Xe = function (e) {
        var t = e.children,
          r = e.className,
    ...
    Xe.defaultProps = { children: k.a.createElement(Be, null) };
    var Ke = function (e) {
        var t = e.isDisabled,
          n = e.theme,
          r = n.spacing.baseUnit,
      ...
      Ze = function (e) {
        ...
        return k.a.createElement(
          ...
          U({}, a, {
            className: r(
              n.i(S.a)(o("indicatorSeparator", e)),
    ...
    var Je = function (e) {
      ...
      return k.a.createElement(
        ...
        U({}, a, {
          className: r(
            n.i(S.a)(o("loadingIndicator", e)),
            { indicator: !0, "loading-indicator": !0 },
            t
          ),
        }),
        k.a.createElement(Qe, { color: l, delay: 0, offset: s }),
        k.a.createElement(Qe, { color: l, delay: 160, offset: !0 }),
        k.a.createElement(Qe, { color: l, delay: 320, offset: !s })
      );
    };
    Je.defaultProps = { size: 4 };
    var et = function (e) {
        var t = e.isDisabled,
          n = e.isFocused,
          r = e.theme,
      ...
      rt = function (e) {
        ...
        return k.a.createElement(
          "div",
          { className: o(n.i(S.a)(a("group", e)), { group: !0 }, r) },
          k.a.createElement(i, U({}, s, { theme: l, getStyles: a, cx: o }), u),
          k.a.createElement("div", null, t)
        );
      },
      ot = function (e) {
        var t = e.theme.spacing;
      ...
      at = function (e) {
        ...
        return k.a.createElement(
          ...
          U(
            {
              className: r(
                n.i(S.a)(o("groupHeading", U({ theme: a }, i))),
                { "group-heading": !0 },
                t
              ),
            },
      ...
      ut = function (e) {
        ...
        return k.a.createElement(
          "div",
          { className: n.i(S.a)(o("input", U({ theme: u }, l))) },
          k.a.createElement(
            P.a,
            U(
              {
                className: r(null, { input: !0 }, t),
                inputRef: a,
                inputStyle: st(i),
                disabled: s,
              },
    ...
    mt.defaultProps = { children: k.a.createElement(Be, { size: 14 }) };
    var vt = (function (e) {
      function t() {
        return (
          L(this, t),
            ...
            value: function () {
              var e = this.props,
                ...
                m = U(
                  {
                    className: a(
                      n.i(S.a)(s("multiValue", this.props)),
                ...
                v = {
                  className: a(
                    n.i(S.a)(s("multiValueLabel", this.props)),
                ...
                g = U(
                  {
                    className: a(
                      n.i(S.a)(s("multiValueRemove", this.props)),
              ...
              return k.a.createElement(
                ...
                k.a.createElement(
                  d,
                  { data: i, innerProps: v, selectProps: p },
                  t
                ),
                k.a.createElement(h, { data: i, innerProps: g, selectProps: p })
              );
            },
          },
        ]),
    ...
    vt.defaultProps = { cropWithEllipsis: !0 };
    var gt = function (e) {
        var t = e.isDisabled,
          n = e.isFocused,
          r = e.isSelected,
        ...
        return {
          ...
          ":active": { backgroundColor: r ? i.primary : i.primary50 },
        };
      },
      yt = function (e) {
        var t = e.children,
      ...
      kt = { baseUnit: 4, controlHeight: 38, menuGutter: 8 },
      St = { borderRadius: 4, colors: Ot, spacing: kt },
      At = {
      ...
      Mt = (function (e) {
        function t(e) {
          ...
          Rt.call(r);
          var o = e.value;
          (r.cacheComponents = n.i(N.a)(r.cacheComponents, y).bind(r)),
            r.cacheComponents(e.components),
            (r.instancePrefix = "react-select-" + (r.props.instanceId || ++It));
          var a = q(o),
          ...
          j(t, [
              ...
              value: function (e) {
                ...
                ((o && !n && e.isDisabled) || (o && r && !e.menuIsOpen)) &&
                  ...
                  this.menuListRef &&
                    ...
                    f(this.menuListRef, this.focusedOptionRef),
              ...
              value: function () {
                ...
                if (a.length) {
                  var i = 0,
                    s = a.indexOf(r);
                  r ||
                    ((s = -1), this.announceAriaLiveContext({ event: "menu" })),
                    "up" === e
                      ? (i = s > 0 ? s - 1 : a.length - 1)
                      : "down" === e
                      ? (i = (s + 1) % a.length)
                      : "pageup" === e
                      ? (i = s - t) < 0 && (i = 0)
                      : "pagedown" === e
                      ? (i = s + t) > a.length - 1 && (i = a.length - 1)
                      : "last" === e && (i = a.length - 1),
                    (this.scrollToFocusedOptionOnUpdate = !0),
                ...
                return a.reduce(
                  function (e, t, r) {
                    if (t.options) {
                      ...
                      var u = i(t, "" + r);
                      u &&
                        (e.render.push(u), u.isDisabled || e.focusable.push(t));
                    }
                    return e;
                  },
                  { render: [], focusable: [] }
            ...
            },
            {
              ...
              value: function () {
                ...
                return k.a.createElement(
                  e,
                  U({}, t, { innerProps: i, isDisabled: r, isFocused: a })
                );
              },
            },
            {
                ...
                var D = {
                  ...
                  F = k.a.createElement(Z, U({}, c, D), function (t) {
                    ...
                    return k.a.createElement(
                      ...
                      k.a.createElement(
                        Te,
                        { isEnabled: m, onTopArrive: A, onBottomArrive: I },
                        k.a.createElement(
                          Ce,
                          { isEnabled: T },
                          k.a.createElement(
    ...
    var Rt = function () {
        ...
        (this.state = {
          ...
          (this.selectOption = function (t) {
            ...
            if (n.isMulti) {
              ...
              if (e.isOptionSelected(t, o)) {
                ...
                e.setValue([].concat(G(o), [t]), "select-option", t),
                  e.announceAriaLiveSelection({
                    event: "select-option",
                    context: { value: e.getOptionLabel(t) },
                  });
          ...
          (this.announceAriaLiveSelection = function (t) {
            var n = t.event,
              r = t.context;
            e.setState({ ariaLiveSelection: ke(n, r) });
          }),
          ...
          (this.onKeyDown = function (t) {
            var n = e.props,
              ...
              g = d.selectValue;
            if (
              !(u || ("function" == typeof c && (c(t), t.defaultPrevented)))
            ) {
      ...
      Nt = { cacheOptions: !1, defaultOptions: !1 },
      Dt = function (e) {
        var t, n;
        return (
          (n = t = (function (t) {
      ...
      Ht = U({ allowCreateWhileLoading: !1, createOptionPosition: "last" }, jt),
      Ut = function (e) {
        var t, n;
        return (
          (n = t = (function (t) {
      ...
      zt = function (e) {
        ...
        return k.a.createElement(
          ...
          function (e) {
            var n = { style: U({}, i[e]) };
            return k.a.createElement(t, U({ innerProps: n }, a));
          }
        );
      },
      Wt = 260,
      ...
      Yt = function (e) {
        return function (t) {
          ...
          return k.a.createElement(e, U({ innerRef: n }, r));
        };
      },
      qt = function (e) {
        return function (t) {
          ...
          return k.a.createElement(
            Gt,
            { in: n, onExited: r },
            k.a.createElement(e, U({ cropWithEllipsis: n }, o))
          );
        };
      },
      Xt = function (e) {
        return function (t) {
          return k.a.createElement(
            zt,
            U({ component: e, duration: t.isMulti ? Wt : 1 }, t)
          );
        };
      },
      Kt = function (e) {
        return function (t) {
          return k.a.createElement(zt, U({ component: e }, t));
        };
      },
      Zt = function (e) {
        return function (t) {
          return k.a.createElement(D.TransitionGroup, U({ component: e }, t));
        };
      },
      $t = function (e) {
        var t = _t({ components: e }),
          n = t.Input,
          r = t.MultiValue,
          o = t.Placeholder,
          a = t.SingleValue,
  ...
  function (e, t, n) {
    ...
    (h.propTypes = {
      ...
      children: p.default.oneOfType([p.default.array, p.default.element])
        .isRequired,
      id: p.default.string,
    }),
      (h.defaultProps = { collapsed: !1 }),
      (t.default = h);
  },
  function (e, t, n) {
    "use strict";
              ...
              value: function () {
                var e = this.props,
                  ...
                  o = {
                    ...
                    onChange: function (t, n) {
                      ...
                      e.isSingle || (r += "." + e.name),
                        L.updateEntity.apply(this, [e.entity, r, n]);
                    },
                    value: r,
                  },
                  a = {
                ...
                if (e.schema.oneOf && e.schema.oneOf.length > 0)
                  return c.default.createElement(
                    S.default,
                    s({}, o, { options: e.schema.oneOf })
                  );
                if ("map" === n || t)
                  return c.default.createElement(I.default, o);
                switch (n) {
                  case "number":
              ...
              value: function () {
                ...
                return c.default.createElement(
                  ...
                  c.default.createElement(
                    "label",
                    { htmlFor: this.id, className: "text", title: n },
                    e.name
                  ),
  ...
  function (e, t, n) {
    ...
    var i = (function () {
      ...
      c = (function (e) {
        function t(e) {
          ...
          return (
            (n.handleGlobalKeydown = function (e) {
              n.state.isOpen &&
                (27 === e.keyCode ||
                ...
                return l.createElement(
                  ...
                  l.createElement(
                    ...
                    l.createElement(
                      ...
                      l.createElement("h3", null, this.props.title)
                    ),
                    l.createElement(
                      "div",
    ...
    (c.propTypes = {
      id: u.default.string,
      children: u.default.oneOfType([u.default.array, u.default.element])
        .isRequired,
      ...
      (c.defaultProps = { closeOnClickOutside: !0 }),
      (t.default = c);
  },
  function (e, t, n) {
    "use strict";
      ...
      c = (function (e) {
        function t(e) {
          ...
          return (
            ...
            (n.state = { value: a, pickerValue: n.getHexString(a) }),
            n
          );
        }
        return (
          ...
          s(t, [
            {
              key: "componentWillReceiveProps",
              value: function (e) {
                e.value !== this.state.value.value &&
                  this.setState({ value: { value: e.value, label: e.value } });
              },
            },
            {
              key: "render",
  ...
  function (e, t, n) {
    ...
    function s(e) {
      return (
        ...
        document.querySelector(e).getAttribute("src")
      );
    }
    function u(e) {
      if (e) {
    ...
    (g.propTypes = {
      ...
      (g.defaultProps = { value: "", mapName: "nomap", dataURL: "" }),
      (t.default = g);
  },
  function (e, t, n) {
    "use strict";
              ...
              value: function () {
                ...
                return p.default.createElement(
                  ...
                  p.default.createElement(
                    m.default,
                    u({ name: "x", value: this.state.x }, e)
                  ),
                  p.default.createElement(
                    m.default,
                    u({ name: "y", value: this.state.y }, e)
                  )
                );
              },
            },
  ...
  function (e, t, n) {
    ...
    function u(e, t, n) {
      for (
        _.unmountComponent(e, n), t.nodeType === N && (t = t.documentElement);
        t.lastChild;
    ...
    function c(e) {
      return !(
        !e ||
        (e.nodeType !== P && e.nodeType !== N && e.nodeType !== D)
      );
    }
    function p(e) {
      var t = o(e),
        ...
        if (y) {
          ...
          if (y !== e.entries)
            for (var w = 0; !(b = E.next()).done; )
              (d = b.value), (h = v + r(d, w++)), (m += o(d, h, n, a));
          else
            for (; !(b = E.next()).done; ) {
              var x = b.value;
              x &&
                ((d = x[1]),
                (h = v + l.escape(x[0]) + p + r(d, 0)),
                (m += o(d, h, n, a)));
            }
        } else if ("object" === f) {
          var C = "",
  ...
  function (e, t, n) {
    ...
    (m.contextTypes = { transitionGroup: s.object }),
        ...
        return (
          ...
          (n.render = function () {
            ...
            return (
              ...
              delete r.enter,
              delete r.exit,
              null === t ? a : l.default.createElement(t, r, a)
            );
          }),
          t
        );
  ...
  function (e, t, n) {
    ...
    function o() {
      ...
      (this.assetsLoader = new m()),
        ...
        (this.opened = !1);
      !(function t() {
        return AFRAME.scenes.length
          ? ((e.sceneEl = AFRAME.scenes[0]),
            e.sceneEl.hasLoaded
              ? void e.init()
              : void e.sceneEl.addEventListener("loaded", e.init.bind(e), {
                  once: !0,
                }))
      ...
      (o.prototype = {
        init: function () {
          ...
          if (!this.sceneEl.camera)
            return void this.sceneEl.addEventListener(
              "camera-set-active",
              function () {
                e.init();
              },
        ...
        initUI: function () {
          ...
          (t.id = "aframeInspector"),
            ...
            u.default.render(i.default.createElement(c.default, null), t),
            ...
            (this.viewport = new h(this)),
            d.emit("windowresize"),
            this.sceneEl.object3D.traverse(function (t) {
              e.addHelper(t);
            }),
        ...
        addHelper: (function () {
          new THREE.SphereBufferGeometry(2, 4, 2),
            new THREE.MeshBasicMaterial({ color: 16711680, visible: !1 });
          return function (e) {
            var t = void 0;
        ...
        removeHelpers: function (e) {
          ...
          e.traverse(function (e) {
            ...
            n &&
              (t.sceneHelpers.remove(n),
              delete t.helpers[e.uuid],
              d.emit("helperremove", t.helpers[e.uuid]));
          });
        },
        selectEntity: function (e, t) {
          ...
          (this.selectedEntity = e),
            ...
            e && void 0 === t && d.emit("entityselect", e);
        ...
        select: function (e) {
          this.selected !== e &&
            ((this.selected = e), d.emit("objectselect", e));
        },
        deselect: function () {
          this.select(null);
        },
        ...
        open: function (e) {
          (this.opened = !0),
            ...
            e && (this.selectEntity(e), d.emit("objectfocus", e.object3D)),
            (this.isFirstOpen = !1);
        },
        close: function () {
          (this.opened = !1),
            d.emit("inspectortoggle", !1),
    ...
    function r(e) {
      function t(e, r, u, l, c) {
        for (
          ...
          if (
            ...
            switch (h) {
              case 123:
                for (
                  B = B.trim(), d = B.charCodeAt(0), m = 1, H = ++D;
                  D < U;
                ...
                switch (
                  ((m = u.substring(H, D)),
                  0 === d && (d = (B = B.replace(p, "").trim()).charCodeAt(0)),
                  d)
                ) {
                  case 64:
                    switch (
                      (0 < L && (B = B.replace(f, "")), (h = B.charCodeAt(1)))
                    ) {
                      case 100:
                      case 109:
                      case 115:
              ...
              case 59:
                if (
                  ((B = (0 < L ? B.replace(f, "") : B).trim()),
                  1 < (H = B.length))
                )
                  switch (
                    (0 === P &&
                      (45 === (d = B.charCodeAt(0)) || (96 < d && 123 > d)) &&
                      (H = (B = B.replace(" ", ":")).length),
                    0 < N &&
                      void 0 !== (g = s(1, B, r, e, A, S, z.length, l, c, l)) &&
                      0 === (H = (B = g.trim()).length) &&
                      (B = "\0\0"),
                    (d = B.charCodeAt(0)),
                    (h = B.charCodeAt(1)),
            ...
            case 10:
              47 === C
                ...
                : 0 === 1 + d &&
                  ...
                  0 < B.length &&
                  ((L = 1), (B += "\0")),
                0 < N * F && s(0, B, r, e, A, S, z.length, l, c, l),
                (S = 1),
                A++;
              break;
            case 59:
        ...
        if (0 < (H = z.length)) {
          if (
            ((L = r),
            0 < N &&
              void 0 !== (g = s(2, z, L, e, A, S, H, l, c, l)) &&
              0 === (z = g).length)
          )
            return G + z + W;
          if (((z = L.join(",") + "{" + z + "}"), 0 != M * I)) {
      ...
      function s(e, t, n, r, o, a, i, s, u, l) {
        for (var p, f = 0, d = t; f < N; ++f)
          switch ((p = P[f].call(c, e, d, n, r, o, a, i, s, u, l))) {
            case void 0:
            case !1:
            case !0:
            case null:
      ...
      function c(e, n) {
        var r = e;
        if (
          (33 > r.charCodeAt(0) && (r = r.trim()), (L = r), (r = [L]), 0 < N)
        ) {
        ...
        return (
          0 < N &&
            void 0 !== (o = s(-2, a, r, r, A, S, a.length, 0, 0, 0)) &&
            (a = o),
          (L = ""),
          (I = 0),
          (S = A = 1),
          ...
          T.on("togglesidebar", function (e) {
            "all" === e.which
              ? n.state.visible.scenegraph || n.state.visible.attributes
                ? n.setState({ visible: { scenegraph: !1, attributes: !1 } })
                : n.setState({ visible: { scenegraph: !0, attributes: !0 } })
              : "attributes" === e.which
              ? n.setState(function (e) {
                  return { visible: { attributes: !e.visible.attributes } };
                })
              : "scenegraph" === e.which &&
                n.setState(function (e) {
                  return { visible: { scenegraph: !e.visible.scenegraph } };
                }),
              n.forceUpdate();
          }),
          n
      ...
      return (
        ...
        s(t, [
          ...
          },
          {
            ...
            value: function () {
              var e = this;
              return !this.state.entity || this.state.visible.attributes
                ? null
                : l.default.createElement(
                    "div",
                    ...
                    l.default.createElement("a", {
                      onClick: function () {
                        e.setState({ visible: { attributes: !0 } }),
                          e.forceUpdate();
                      },
          ...
          },
          {
            ...
            value: function () {
              var e = this;
              return this.state.visible.scenegraph
                ? null
                : l.default.createElement(
                    "div",
                    ...
                    l.default.createElement("a", {
                      onClick: function () {
                        e.setState({ visible: { scenegraph: !0 } }),
                          e.forceUpdate();
                      },
                      className: "fa fa-plus",
  ...
  function (e, t, n) {
        ...
        function t() {
          ...
          return (
            ...
            (r.addComponent = function (e) {
              ...
              n.setAttribute(t, ""),
                d.default.emit("componentadd", { entity: n, component: t }),
    ...
    (v.propTypes = { entity: p.default.object }), (t.default = v);
  },
  function (e, t, n) {
    "use strict";
    function r(e) {
              ...
              value: function () {
                ...
                _.default.on("entityupdate", function (t) {
                  t.entity === e.props.entity &&
                    -1 !== m.default.indexOf(t.component) &&
                    e.forceUpdate();
                }),
                  ...
                  new O.default('[data-action="copy-entity-to-clipboard"]', {
                    text: function (t) {
                      return (0, x.getEntityClipboardRepresentation)(
                        e.props.entity
                      );
                    },
                  }).on("error", function (e) {});
                ...
                return c.default.createElement(
                  ...
                  c.default.createElement(
                    ...
                    c.default.createElement(
                      ...
                      c.default.createElement(d.InputWidget, {
                        onChange: s,
                        entity: t,
                        name: "id",
                        value: t.id,
                    ...
                    c.default.createElement(w.default, { entity: t })
                  )
                );
              },
            },
    ...
    (S.propTypes = { entity: f.default.object }), (t.default = S);
  },
  function (e, t, n) {
    "use strict";
    function r(e) {
    ...
    var s = (function () {
      ...
      x = (function (e) {
        function t(e) {
          ...
          return (
            (n.removeComponent = function (e) {
              var t = n.props.name;
              e.stopPropagation(),
                confirm(
                  "Do you really want to remove component `" + t + "`?"
                ) &&
                  (n.props.entity.removeAttribute(t),
                  E.default.emit("componentremove", {
        ...
        return (
          ...
          s(t, [
                ...
                new g.default('[data-action="copy-component-to-clipboard"]', {
                  text: function (t) {
                    ...
                    return (
                      ...
                      (0, y.getComponentClipboardRepresentation)(
                        e.state.entity,
                        n
                      )
                    );
            ...
            },
            {
              key: "componentWillReceiveProps",
              value: function (e) {
                this.state.entity !== e.entity &&
                  this.setState({ entity: e.entity }),
                  this.state.name !== e.name && this.setState({ name: e.name });
              },
            },
            {
              key: "render",
                ...
                return (
                  ...
                  l.default.createElement(
                    ...
                    l.default.createElement(
                      ...
                      l.default.createElement(
                        "span",
                        { className: "componentTitle", title: t || e },
                        l.default.createElement("span", null, t || e)
                      ),
                      l.default.createElement(
                        "div",
  ...
  function (e, t, n) {
          ...
          s(t, [
            {
              ...
              value: function () {
                ...
                return l.default.createElement(
                  ...
                  l.default.createElement(g.default, { entity: e }),
                  l.default.createElement(d.default, { entity: e }),
                  r
                );
              },
            },
    ...
    (E.propTypes = { entity: p.default.object }), (t.default = E);
  },
  function (e, t, n) {
    "use strict";
    function r(e) {
    ...
    (m.propTypes = { entity: p.default.object.isRequired }), (t.default = m);
  },
  function (e, t, n) {
    "use strict";
    function r(e) {
    ...
    (v.propTypes = { entity: p.default.object, visible: p.default.bool }),
      (t.default = v);
  },
  function (e, t, n) {
    "use strict";
                ...
                return l.default.createElement(
                  ...
                  l.default.createElement(
                    ...
                    e.map(function (e, t) {
                      return l.default.createElement(
                        "ul",
                        { className: "help-list", key: t },
                        e.map(function (e) {
                          return l.default.createElement(
                            "li",
                            { key: e.key, className: "help-key-unit" },
                            e.key.map(function (e) {
                              return l.default.createElement(
                                "kbd",
                                { key: e, className: "help-key" },
    ...
    (h.propTypes = { isOpen: p.default.bool, onClose: p.default.func }),
      (t.default = h);
  },
  function (e, t, n) {
    "use strict";
        ...
        function t(e) {
          ...
          return (
            ...
            (n.onNewUrl = function (e) {
              ...
              if (13 === e.keyCode) {
                var r = n;
                n.refs.preview.addEventListener("load", t),
                  (n.refs.preview.src = e.target.value),
            ...
            (n.onNameChanged = function (e) {
              ...
              (t.name = e.target.value), n.setState({ preview: t });
            }),
            (n.toggleNewDialog = function () {
              n.setState({ addNewDialogOpened: !n.state.addNewDialogOpened });
            }),
            (n.onUrlChange = function (e) {
              n.setState({ newUrl: e.target.value });
            }),
            (n.addNewAsset = function () {
              var e = n;
              b(
                "img",
                n.state.preview.name,
                n.state.preview.src,
                !0,
                function () {
                  e.generateFromAssets(),
                    e.setState({ addNewDialogOpened: !1 }),
                    e.clear();
                }
              );
            }),
            (n.onChangeFilter = function (e) {
              n.setState({ filterText: e.target.value });
            }),
            (n.state = {
              filterText: "",
                  ...
                  .map(function (e) {
                    ...
                    return h.default.createElement(
                      ...
                      h.default.createElement(
                        ...
                        h.default.createElement("span", null, s(e.src)),
                        h.default.createElement(
                          "span",
                          null,
                          e.width,
                      ...
                      h.default.createElement(
                        ...
                        this.state.preview.loaded
                          ? h.default.createElement(
                              ...
                              h.default.createElement(
                                "span",
                                { className: "title", title: n.filename },
                                n.filename
                              ),
                        ...
                        h.default.createElement(
                          "button",
                          { disabled: !o, onClick: this.addNewAsset },
                          "LOAD THIS TEXTURE"
                        )
                      )
                    )
                      ...
                      this.state.assetsImages
                        ...
                        .map(
                          function (e) {
                            ...
                            return h.default.createElement(
                              "li",
                              { key: e.id, onClick: t, className: n },
                              h.default.createElement("img", {
                                width: "155px",
                                height: "155px",
                                src: e.src,
                      ...
                      t.map(function (e) {
                        ...
                        return h.default.createElement(
                          ...
                          h.default.createElement(
                            ...
                            " ",
                            h.default.createElement("span", null, s(t.src)),
                            h.default.createElement(
                              "span",
                              null,
                              t.width,
          ...
          s(t, [
            {
              ...
              value: function () {
                ...
                u =
                  r.children.length > 0 && !t
                    ? l.default.createElement("span", {
                        ...
                        className:
                          "collapsespace fa " +
                          (n ? "fa-caret-down" : "fa-caret-right"),
                      })
                    : l.default.createElement("span", {
                ...
                return l.default.createElement(
                  "div",
                  { className: f, onClick: this.onClick },
                  l.default.createElement(
                    "span",
                    null,
                    p,
                    ...
                    u,
                    (0, h.printEntity)(r, this.onDoubleClick)
                  ),
                  l.default.createElement(
                    "span",
  ...
  function (e, t, n) {
    ...
    function s(e, t) {
      return (
        ...
        !(
          ...
          -1 === e.tagName.toUpperCase().indexOf(t.toUpperCase()) &&
    ...
    var u =
      ...
      x = (function (e) {
        function t(e) {
          ...
          return (
            (n.selectEntity = function (e) {
              for (
                var t = !1, r = 0;
                r < n.state.filteredEntities.length;
                r++
              ) {
                n.state.filteredEntities[r].entity === e &&
                  (n.setState({ selectedEntity: e, selectedIndex: r }),
                  n.expandToRoot(e),
                  n.props.onChange && n.props.onChange(e),
                  w.emit("entityselect", e, !0),
                  (t = !0));
              }
              t || n.setState({ selectedEntity: null, selectedIndex: -1 });
            }),
              ...
              function e(n, r) {
                if (n) {
                  ...
                  for (var o = 0; o < n.children.length; o++) {
                    var a = n.children[o];
                    a.dataset.isInspector ||
                      !a.isEntity ||
                      a.isInspector ||
                      "aframeInspector" in a.dataset ||
                      (t.push({ entity: a, depth: r }), e(a, r));
                  }
                }
              }
              var t = [{ depth: 0, entity: n.props.scene }];
              e(n.props.scene, 0),
                n.setState({
                  entities: t,
            ...
            (n.rebuildEntityOptions = (0, v.default)(
              n.rebuildEntityOptions.bind(n),
              1e3
            )),
            (n.updateFilteredEntities = (0, v.default)(
              n.updateFilteredEntities.bind(n),
              500
            )),
            n
          );
          ...
          l(t, [
            {
              ...
              value: function () {
                this.rebuildEntityOptions(),
                  w.on("entityidchange", this.rebuildEntityOptions),
                  w.on("entitycreated", this.rebuildEntityOptions);
              },
            },
            {
              key: "componentDidUpdate",
              ...
              value: function () {
                ...
                return d.default.createElement(
                  ...
                  d.default.createElement(
                    ...
                    d.default.createElement(E.default, null),
                    d.default.createElement(
                      "div",
                      { className: "search" },
                      d.default.createElement("input", {
    ...
    (x.propTypes = {
      ...
      (x.defaultProps = { selectedEntity: "", index: -1, id: "left-sidebar" }),
      (t.default = x);
  },
  function (e, t, n) {
    "use strict";
        ...
        return (
          ...
          c(t, [
            ...
            },
            {
              key: "render",
              value: function () {
                var e = (0, f.default)({ button: !0, fa: !0, "fa-save": !0 });
                return h.default.createElement(
                  "div",
                  { id: "toolbar" },
                  h.default.createElement(
    ...
    var s = (function () {
      ...
      d = (function (e) {
        function t(e) {
          ...
          return (
            (n.state = { selectedCamera: "perspective" }),
            (n.justChangedCamera = !1),
            n
          );
        }
        return (
          ...
          s(t, [
            {
              ...
              value: function () {
                ...
                p.on("cameratoggle", function (t) {
                  if (e.justChangedCamera)
                    return void (e.justChangedCamera = !1);
    ...
    var i = (function () {
      ...
      c = (function (e) {
        function t(e) {
          ...
          return (n.state = { hoveredEntity: null, selectedEntity: null }), n;
        }
        return (
          a(t, e),
          i(t, [
              ...
              value: function () {
                return u.createElement(
                  ...
                  u.createElement(
                    "p",
                    null,
                    (0, s.printEntity)(this.state.hoveredEntity)
                  )
                );
              },
            },
    ...
    (THREE.Box3.prototype.expandByObject = (function () {
          ...
          if (a.isGeometry) {
            ...
            for (n = 0, r = i.length; n < r; n++)
              o.copy(i[n]),
                ...
                isNaN(o.x) || isNaN(o.y) || isNaN(o.z) || t.expandByPoint(o);
          } else if (a.isBufferGeometry) {
            var s = a.attributes.position;
            if (void 0 !== s)
              for (n = 0, r = s.count; n < r; n++)
                o.fromBufferAttribute(s, n).applyMatrix4(e.matrixWorld),
                  isNaN(o.x) || isNaN(o.y) || isNaN(o.z) || t.expandByPoint(o);
          }
      }
      var t,
      ...
      (THREE.EditorControls = function (e, t) {
        ...
        function r(e) {
          if (!1 !== p.enabled) {
            ...
            var t = b.x - E.x,
              n = b.y - E.y;
            v === m.ROTATE
              ? p.rotate(d.set(-t * p.rotationSpeed, -n * p.rotationSpeed, 0))
              : v === m.ZOOM
              ? p.zoom(d.set(0, 0, n))
              : v === m.PAN && p.pan(d.set(-t, n, 0)),
              E.set(e.clientX, e.clientY);
          }
        }
        function a(e) {
        ...
        function u(e) {
          if (!1 !== p.enabled) {
            switch (e.touches.length) {
              case 1:
                T[0].set(e.touches[0].pageX, e.touches[0].pageY, 0),
                  T[1].set(e.touches[0].pageX, e.touches[0].pageY, 0);
                break;
              case 2:
                T[0].set(e.touches[0].pageX, e.touches[0].pageY, 0),
                  T[1].set(e.touches[1].pageX, e.touches[1].pageY, 0),
                  (k = T[0].distanceTo(T[1]));
            }
            ...
            switch (
              ...
              case 1:
                T[0].set(e.touches[0].pageX, e.touches[0].pageY, 0),
                  T[1].set(e.touches[0].pageX, e.touches[0].pageY, 0),
                  p.rotate(
                    T[0].sub(t(T[0], O)).multiplyScalar(-p.rotationSpeed)
                  );
                break;
              case 2:
                T[0].set(e.touches[0].pageX, e.touches[0].pageY, 0),
                ...
                (r.x = -r.x), (o.x = -o.x), p.pan(r.add(o).multiplyScalar(0.5));
            }
            O[0].copy(T[0]), O[1].copy(T[1]);
          }
        }
        ...
        var c = e,
          ...
          d = new THREE.Vector3(),
          h = new THREE.Box3(),
          m = { NONE: -1, ROTATE: 0, ZOOM: 1, PAN: 2 },
          v = m.NONE,
          g = this.center,
          y = new THREE.Matrix3(),
          b = new THREE.Vector2(),
        ...
        (this.dispatchChange = (0, o.default)(function () {
          ...
          (this.focus = function (e) {
            var t;
            h.setFromObject(e),
              !1 !== h.isEmpty() || isNaN(h.min.x)
                ? (g.setFromMatrixPosition(e.matrixWorld), (t = 0.1))
                : (h.getCenter(g), (t = h.getBoundingSphere(x).radius)),
              c.position.copy(e.localToWorld(new THREE.Vector3(0, 0, 2 * t))),
              c.lookAt(e.getWorldPosition(new THREE.Vector3())),
              p.dispatchEvent(C);
          }),
          (this.pan = function (e) {
            var t;
            (t = this.isOrthographic
              ? Math.abs(c.right)
              : c.position.distanceTo(g)),
              e.multiplyScalar(t * p.panSpeed),
              e.applyMatrix3(y.getNormalMatrix(c.matrix)),
              c.position.add(e),
              g.add(e),
              p.dispatchChange();
          });
        ...
        (this.setAspectRatio = function (e) {
          ...
          (this.rotate = function (e) {
            this.rotationEnabled &&
              (f.copy(c.position).sub(g),
              w.setFromVector3(f),
              (w.theta += e.x),
              (w.phi += e.y),
              w.makeSafe(),
              f.setFromSpherical(w),
              c.position.copy(g).add(f),
              c.lookAt(g),
              p.dispatchChange());
          }),
          (this.dispose = function () {
            t.removeEventListener("contextmenu", s, !1),
              t.removeEventListener("mousedown", n, !1),
              t.removeEventListener("wheel", i, !1),
              t.removeEventListener("mousemove", r, !1),
              t.removeEventListener("mouseup", a, !1),
              t.removeEventListener("mouseout", a, !1),
              t.removeEventListener("dblclick", a, !1),
          ...
          t.addEventListener("contextmenu", s, !1),
  ...
  function (e, t, n) {
    ...
    !(function () {
      ...
      (THREE.TransformGizmo = function () {
        ...
        (THREE.TransformGizmo.prototype = Object.create(
        ...
        (THREE.TransformGizmo.prototype.update = function (e, t) {
          ...
          this.traverse(function (a) {
            -1 !== a.name.search("E")
              ? a.quaternion.setFromRotationMatrix(o.lookAt(t, n, r))
              : (-1 === a.name.search("X") &&
                  -1 === a.name.search("Y") &&
                  -1 === a.name.search("Z")) ||
                a.quaternion.setFromEuler(e);
          });
        }),
        (THREE.TransformGizmoTranslate = function () {
          THREE.TransformGizmo.call(this);
          var r = new THREE.ConeBufferGeometry(0.05, 0.2, 12, 1, !1);
          r.translate(0, 0.5, 0);
          ...
          i.addAttribute(
            ...
            (this.handleGizmos = {
              ...
              Z: [
                ...
                [new THREE.Line(i, new t({ color: 255 }))],
              ],
              XYZ: [
                [
                  new THREE.Mesh(
            ...
            (this.pickerGizmos = {
              X: [
                [
                  new THREE.Mesh(
                    new THREE.CylinderBufferGeometry(0.2, 0, 1, 4, 1, !1),
                    n
                  ),
                  [0.6, 0, 0],
                  [0, 0, -Math.PI / 2],
              ...
              XY: [
                [
                  new THREE.Mesh(new THREE.PlaneBufferGeometry(0.4, 0.4), n),
                  [0.2, 0.2, 0],
                ],
              ],
              YZ: [
            ...
            (this.setActivePlane = function (e, t) {
              ...
              t.applyMatrix4(
                n.getInverse(n.extractRotation(this.planes.XY.matrixWorld))
              ),
                "X" === e &&
        ...
        (THREE.TransformGizmoRotate = function () {
          ...
          var e = function (e, t, n) {
            var r = new THREE.BufferGeometry(),
              o = [];
            n = n || 1;
            for (var a = 0; a <= 64 * n; ++a)
              "x" === t &&
                o.push(
                  0,
                  Math.cos((a / 32) * Math.PI) * e,
                  Math.sin((a / 32) * Math.PI) * e
                ),
                "y" === t &&
                  o.push(
                    Math.cos((a / 32) * Math.PI) * e,
          ...
          (this.handleGizmos = {
            X: [
              [new THREE.Line(new e(1, "x", 0.5), new t({ color: 16711680 }))],
            ],
            Y: [[new THREE.Line(new e(1, "y", 0.5), new t({ color: 65280 }))]],
            Z: [[new THREE.Line(new e(1, "z", 0.5), new t({ color: 255 }))]],
            E: [
              [new THREE.Line(new e(1.25, "z", 1), new t({ color: 13421568 }))],
            ],
            XYZE: [
            ...
            (this.update = function (e, t) {
              ...
              r.copy(this.planes.XY.rotation),
                ...
                this.traverse(function (e) {
                  o.setFromEuler(r),
                    "X" === e.name &&
                      (u.setFromAxisAngle(a, Math.atan2(-p.y, p.z)),
                      o.multiplyQuaternions(o, u),
                      e.quaternion.copy(o)),
                    "Y" === e.name &&
                      (l.setFromAxisAngle(i, Math.atan2(p.x, p.z)),
                      o.multiplyQuaternions(o, l),
                      e.quaternion.copy(o)),
                    "Z" === e.name &&
                      (c.setFromAxisAngle(s, Math.atan2(p.y, p.x)),
        ...
        (THREE.TransformGizmoScale = function () {
          THREE.TransformGizmo.call(this);
          var r = new THREE.BoxBufferGeometry(0.125, 0.125, 0.125);
          r.translate(0, 0.5, 0);
          var o = new THREE.BufferGeometry();
          o.addAttribute(
            "position",
          ...
          i.addAttribute(
            ...
            (this.pickerGizmos = {
              ...
              XYZ: [
                [new THREE.Mesh(new THREE.BoxBufferGeometry(0.4, 0.4, 0.4), n)],
              ],
            }),
            (this.setActivePlane = function (e, t) {
              var n = new THREE.Matrix4();
        ...
        (THREE.TransformControls = function (e, t) {
          function n(e) {
            if (
              ...
              var t = e.changedTouches ? e.changedTouches[0] : e,
                ...
                r = null;
              n && ((r = n.object.name), e.preventDefault()),
                u.axis !== r && ((u.axis = r), u.update(), u.dispatchEvent(h));
            }
          }
          function r(e) {
            if (
              ...
              if (0 === t.button || void 0 === t.button) {
                ...
                if (n) {
                  e.preventDefault(),
                    e.stopPropagation(),
                    (u.axis = n.object.name),
                    u.dispatchEvent(m),
                    u.update(),
                    O.copy(Y).sub(z).normalize(),
                    p[l].setActivePlane(u.axis, O);
                  var r = i(t, [p[l].activePlane]);
                  r &&
                    (j.copy(u.object.position),
                    H.copy(u.object.scale),
                    U.extractRotation(u.object.matrix),
                    G.extractRotation(u.object.matrixWorld),
                    V.extractRotation(u.object.parent.matrixWorld),
                    B.setFromMatrixScale(
                      k.getInverse(u.object.parent.matrixWorld)
                    ),
                    w.copy(r.point));
                }
              }
              ...
              !1 !== n &&
                ...
                "translate" === l
                  ? (E.sub(w),
                    E.multiply(B),
                    "local" === u.space &&
                      (E.applyMatrix4(k.getInverse(G)),
                      -1 === u.axis.search("X") && (E.x = 0),
                      -1 === u.axis.search("Y") && (E.y = 0),
                      -1 === u.axis.search("Z") && (E.z = 0),
                      E.applyMatrix4(U),
                      u.object.position.copy(j),
                      u.object.position.add(E)),
                    ("world" !== u.space && -1 === u.axis.search("XYZ")) ||
                      (-1 === u.axis.search("X") && (E.x = 0),
                      -1 === u.axis.search("Y") && (E.y = 0),
                      -1 === u.axis.search("Z") && (E.z = 0),
                      E.applyMatrix4(k.getInverse(V)),
                      u.object.position.copy(j),
                      u.object.position.add(E)),
                    null !== u.translationSnap &&
                      ("local" === u.space &&
                        u.object.position.applyMatrix4(k.getInverse(G)),
                      -1 !== u.axis.search("X") &&
                        (u.object.position.x =
                          Math.round(u.object.position.x / u.translationSnap) *
                          u.translationSnap),
                      -1 !== u.axis.search("Y") &&
                        (u.object.position.y =
                          Math.round(u.object.position.y / u.translationSnap) *
                          u.translationSnap),
                      -1 !== u.axis.search("Z") &&
                        (u.object.position.z =
                          Math.round(u.object.position.z / u.translationSnap) *
                          u.translationSnap),
                      "local" === u.space && u.object.position.applyMatrix4(G)))
                  : "scale" === l
                  ? (E.sub(w),
                    E.multiply(B),
                    "local" === u.space &&
                      ("XYZ" === u.axis
                        ? ((_ = 1 + E.y / Math.max(H.x, H.y, H.z)),
                          (u.object.scale.x = H.x * _),
                          (u.object.scale.y = H.y * _),
                          (u.object.scale.z = H.z * _))
                        : (E.applyMatrix4(k.getInverse(G)),
                          "X" === u.axis &&
                            (u.object.scale.x = H.x * (1 + E.x / H.x)),
                          "Y" === u.axis &&
                            (u.object.scale.y = H.y * (1 + E.y / H.y)),
                          "Z" === u.axis &&
                            (u.object.scale.z = H.z * (1 + E.z / H.z)))))
                  : "rotate" === l &&
                    (E.sub(z),
                    E.multiply(B),
                    S.copy(w).sub(z),
                    S.multiply(B),
                    "E" === u.axis
                      ? (E.applyMatrix4(k.getInverse(T)),
                        S.applyMatrix4(k.getInverse(T)),
                        x.set(
                          Math.atan2(E.z, E.y),
                          Math.atan2(E.x, E.z),
                          Math.atan2(E.y, E.x)
                        ...
                        A.setFromRotationMatrix(k.getInverse(V)),
                        L.setFromAxisAngle(O, x.z - C.z),
                        P.setFromRotationMatrix(G),
                        A.multiplyQuaternions(A, L),
                        A.multiplyQuaternions(A, P),
                        u.object.quaternion.copy(A))
                      : "XYZE" === u.axis
                      ? (L.setFromEuler(E.clone().cross(S).normalize()),
                        A.setFromRotationMatrix(k.getInverse(V)),
                        N.setFromAxisAngle(L, -E.clone().angleTo(S)),
                        P.setFromRotationMatrix(G),
                        A.multiplyQuaternions(A, N),
                        A.multiplyQuaternions(A, P),
                        u.object.quaternion.copy(A))
                      : "local" === u.space
                      ? (E.applyMatrix4(k.getInverse(G)),
                        S.applyMatrix4(k.getInverse(G)),
                        x.set(
                          Math.atan2(E.z, E.y),
                          Math.atan2(E.x, E.z),
                          Math.atan2(E.y, E.x)
                        ...
                        null !== u.rotationSnap
                          ? (N.setFromAxisAngle(
                              I,
                              Math.round((x.x - C.x) / u.rotationSnap) *
                                u.rotationSnap
                            ),
                            D.setFromAxisAngle(
                              M,
                              Math.round((x.y - C.y) / u.rotationSnap) *
                                u.rotationSnap
                            ),
                            F.setFromAxisAngle(
                              R,
                              Math.round((x.z - C.z) / u.rotationSnap) *
                                u.rotationSnap
                            ))
                          : (N.setFromAxisAngle(I, x.x - C.x),
                            D.setFromAxisAngle(M, x.y - C.y),
                            F.setFromAxisAngle(R, x.z - C.z)),
                        "X" === u.axis && P.multiplyQuaternions(P, N),
                        "Y" === u.axis && P.multiplyQuaternions(P, D),
                        "Z" === u.axis && P.multiplyQuaternions(P, F),
                        u.object.quaternion.copy(P))
                      : "world" === u.space &&
                        (x.set(
                          Math.atan2(E.z, E.y),
                          Math.atan2(E.x, E.z),
                        ...
                        null !== u.rotationSnap
                          ...
                          : (N.setFromAxisAngle(I, x.x - C.x),
                            ...
                            F.setFromAxisAngle(R, x.z - C.z)),
                        P.setFromRotationMatrix(G),
                        "X" === u.axis && A.multiplyQuaternions(A, N),
                        "Y" === u.axis && A.multiplyQuaternions(A, D),
                        "Z" === u.axis && A.multiplyQuaternions(A, F),
                        A.multiplyQuaternions(A, P),
                        u.object.quaternion.copy(A))),
                "translate" === l
                  ? ((u.object.position.x = parseFloat(
                      u.object.position.x.toFixed(5)
                    )),
                    (u.object.position.y = parseFloat(
                      u.object.position.y.toFixed(5)
                    )),
                    (u.object.position.z = parseFloat(
                      u.object.position.z.toFixed(5)
                    )))
                  : "rotate" === l
                  ? ((u.object.rotation.x = parseFloat(
                      u.object.rotation.x.toFixed(5)
                    )),
                    (u.object.rotation.y = parseFloat(
                      u.object.rotation.y.toFixed(5)
                    )),
                    (u.object.rotation.z = parseFloat(
                      u.object.rotation.z.toFixed(5)
                    )))
                  : ((u.object.scale.x = parseFloat(
                      u.object.scale.x.toFixed(5)
                    )),
                    (u.object.scale.y = parseFloat(
                      u.object.scale.y.toFixed(5)
                    )),
                    (u.object.scale.z = parseFloat(
                      u.object.scale.z.toFixed(5)
                    ))),
                u.update(),
                u.dispatchEvent(h),
                (g.mode = l),
          ...
          function a(e) {
            e.preventDefault(),
              (void 0 !== e.button && 0 !== e.button) ||
                (c && null !== u.axis && ((v.mode = l), u.dispatchEvent(v)),
                (c = !1),
                "TouchEvent" in window && e instanceof TouchEvent
                  ? ((u.axis = null), u.update(), u.dispatchEvent(h))
                  : n(e));
          }
          function i(e, n) {
          ...
          (this.setCamera = function (e) {
            ...
            (this.update = function (e) {
              void 0 !== u.object &&
                ...
                z.setFromMatrixPosition(u.object.matrixWorld),
                W.setFromRotationMatrix(
                  k.extractRotation(u.object.matrixWorld)
                ),
                s.updateMatrixWorld(),
                Y.setFromMatrixPosition(s.matrixWorld),
                q.setFromRotationMatrix(k.extractRotation(s.matrixWorld)),
                (_ = (z.distanceTo(Y) / 6) * u.size),
                this.position.copy(z),
                e && this.scale.set(_, _, _),
                ...
                "local" === u.space
                  ? p[l].update(W, O)
                  : "world" === u.space && p[l].update(new THREE.Euler(), O),
                p[l].highlight(u.axis));
            });
        }),
        (THREE.TransformControls.prototype = Object.create(
          THREE.Object3D.prototype
        )),
        (THREE.TransformControls.prototype.constructor =
          ...
          (t.onload = function () {
            ...
            (e.images = n.images),
              e.images.forEach(function (e) {
                (e.fullPath = i + n.basepath.images + e.path),
                  (e.fullThumbPath =
                    i + n.basepath.images_thumbnails + e.thumbnail);
              }),
  ...
  function (e, t, n) {
    ...
    function r(e) {
      ...
      e.currentCameraEl.setAttribute(
        ...
        e.currentCameraEl.hasAttribute("data-aframe-default-camera") &&
          (e.currentCameraEl.removeAttribute("data-aframe-default-camera"),
          e.currentCameraEl.setAttribute(
      ...
      (r.far = 1e4),
        (r.near = 0.01),
        r.position.set(0, 1.6, 2),
        r.lookAt(new THREE.Vector3(0, 1.6, -1)),
        r.updateMatrixWorld(),
        t.object3D.add(r),
        (t.camera = r);
      ...
      t.object3D.add(l);
      var c = (e.cameras = { perspective: r, original: n, ortho: l });
      return (
        s.default.on("cameraperspectivetoggle", function () {
          o(e.camera, u),
            (t.camera = e.camera = c.perspective),
            s.default.emit("cameratoggle", {
              camera: e.camera,
              value: "perspective",
            });
        }),
        s.default.on("cameraorthographictoggle", function (n) {
          o(e.camera, u),
            (t.camera = e.camera = c.ortho),
            (u = n),
            a(c.ortho, n, i),
            0 === c.ortho.rotation.x &&
              0 === c.ortho.rotation.y &&
              0 === c.ortho.rotation.z &&
              c.ortho.lookAt(0, 0, 0),
            s.default.emit("cameratoggle", {
              camera: e.camera,
              value: "ortho" + n,
            });
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }), (t.initCameras = r);
    var i = n(5),
      s = (function (e) {
        return e && e.__esModule ? e : { default: e };
      })(i),
    ...
    r.on("entityupdate", function (e) {
      ...
      r &&
        (e.property
          ...
          : ((t = r.schema.stringify(e.value)), (o[n.id][e.component] = t)));
    }),
      (e.exports = { updates: o });
  },
  function (e, t, n) {
    ...
    function r(e) {
      ...
      function r(t) {
        h.distanceTo(m) >= 0.03 || e.selectEntity(t.detail.intersectedEl);
      }
      function s(t) {
      ...
      c.setAttribute("id", "aframeInspectorMouseCursor"),
        c.setAttribute("cursor", "rayOrigin", "mouse"),
        c.setAttribute("data-aframe-inspector", "true"),
      ...
      (p.refreshObjects = d),
        ...
        e.container.addEventListener("mousedown", s),
        e.container.addEventListener("mouseup", u),
        e.container.addEventListener("dblclick", l),
      ...
      s = {
        ...
        onKeyUp: function (e) {
          if (r(e) && AFRAME.INSPECTOR.opened) {
            var t = e.keyCode;
            if (
              (72 === t && i.emit("openhelpmodal"),
              27 === t &&
                this.inspector.selectedEntity &&
                this.inspector.selectEntity(null),
              87 === t && i.emit("transformmodechange", "translate"),
              69 === t && i.emit("transformmodechange", "rotate"),
              82 === t && i.emit("transformmodechange", "scale"),
              79 === t && i.emit("transformspacechange"),
              71 === t && i.emit("togglegrid"),
              77 === t && i.emit("togglemotioncapture"),
              78 === t &&
                i.emit("entitycreate", { element: "a-entity", components: {} }),
              (8 !== t && 46 !== t) || (0, o.removeSelectedEntity)(),
              68 === t && (0, o.cloneSelectedEntity)(),
              70 === t)
            ) {
              var n = AFRAME.INSPECTOR.selectedEntity;
            ...
            49 === t
              ? i.emit("cameraperspectivetoggle")
              : 50 === t
              ? i.emit("cameraorthographictoggle", "left")
              : 51 === t
              ? i.emit("cameraorthographictoggle", "right")
              : 52 === t
              ? i.emit("cameraorthographictoggle", "top")
              : 53 === t
              ? i.emit("cameraorthographictoggle", "bottom")
              : 54 === t
              ? i.emit("cameraorthographictoggle", "back")
              : 55 === t && i.emit("cameraorthographictoggle", "front");
            for (var a in this.shortcuts.modules) {
              var s = this.shortcuts.modules[a];
              s[t] &&
                (!s[t].mustBeActive ||
                  (s[t].mustBeActive && AFRAME.INSPECTOR.modules[a].active)) &&
                this.shortcuts.modules[a][t].callback();
            }
          }
        },
        onKeyDown: function (e) {
          r(e) &&
            ...
            (((e.ctrlKey && "windows" === a.os) ||
              (e.metaKey && "macos" === a.os)) &&
              (AFRAME.INSPECTOR.selectedEntity &&
                "INPUT" !== document.activeElement.tagName &&
                (88 === e.keyCode &&
                  ((AFRAME.INSPECTOR.entityToCopy =
                    AFRAME.INSPECTOR.selectedEntity),
                  (0, o.removeSelectedEntity)(!0)),
                67 === e.keyCode &&
                  (AFRAME.INSPECTOR.entityToCopy =
                    AFRAME.INSPECTOR.selectedEntity),
                86 === e.keyCode &&
                  (0, o.cloneEntity)(AFRAME.INSPECTOR.entityToCopy)),
              83 === e.keyCode &&
                (e.preventDefault(),
                e.stopPropagation(),
                document.getElementById("filter").focus())),
            48 === e.keyCode &&
              (i.emit("togglesidebar", { which: "all" }),
              e.preventDefault(),
              e.stopPropagation()));
        },
        enable: function () {
  ...
  function (e, t, n) {
    ...
    function o(e) {
      ...
      (p.material.depthTest = !1),
        (p.material.transparent = !0),
        p.material.color.set(2075378),
        (p.visible = !1),
        s.add(p);
      var f = e.camera,
        d = new THREE.TransformControls(f, e.container);
      (d.size = 0.75),
        d.addEventListener("objectChange", function (e) {
          var n = d.object;
          if (void 0 !== n) {
            p.setFromObject(n).update(),
              t(n),
              l.emit("refreshsidebarobject3d", n);
            var r = void 0,
              o = void 0;
            if ("translate" === e.mode)
              (r = "position"),
              ...
              o =
                a(n.rotation.x) + " " + a(n.rotation.y) + " " + a(n.rotation.z);
            } else
              "scale" === e.mode &&
                ((r = "scale"),
                (o = n.scale.x + " " + n.scale.y + " " + n.scale.z));
            l.emit("entityupdate", {
              component: r,
              entity: d.object.el,
              property: "",
        ...
        s.add(d),
        l.on("entityupdate", function (t) {
          e.selectedEntity.object3DMap.mesh && p.update(e.selected);
        });
      var h = new THREE.EditorControls(f, e.container);
      h.center.set(0, 1.6, 0),
        (h.rotationSpeed = 0.0035),
        (h.zoomSpeed = 0.05),
        h.setAspectRatio(a.canvas.width / a.canvas.height),
        l.on("cameratoggle", function (e) {
          h.setCamera(e.camera), d.setCamera(e.camera);
        }),
        r(),
        l.on("inspectorcleared", function () {
          h.center.set(0, 0, 0);
        }),
          ...
          (p.visible = !1),
            ...
            e &&
              ...
              (e.el.getObject3D("mesh") &&
                (p.setFromObject(e).update(), (p.visible = !0)),
              d.attach(e));
        }),
        ...
        l.on("entityupdate", function (n) {
          ...
          e.selected === r &&
            r.geometry &&
            ((r.geometry.vertices && r.geometry.vertices.length > 0) ||
              (r.geometry.attributes &&
                r.geometry.attributes.position &&
                r.geometry.attributes.position.array.length)) &&
            p.setFromObject(r).update(),
            d.update(),
            r instanceof THREE.PerspectiveCamera && r.updateProjectionMatrix(),
            t(r);
        }),
        l.on("windowresize", function () {
          (f.aspect = e.container.offsetWidth / e.container.offsetHeight),
        ...
        l.on("inspectortoggle", function (t) {
          t
            ...
            : (n(),
              ...
              (AFRAME.scenes[0].camera = e.cameras.original.getObject3D(
                "camera"
              )),
              Array.prototype.slice
                .call(document.querySelectorAll(".a-enter-vr,.rs-base"))
      ...
      (THREE.GLTFExporter.prototype = {
        ...
        parse: function (e, t, n) {
          ...
          function u(e, t, n) {
            for (
              ...
              for (var a = 0; a < e.itemSize; a++) {
                ...
                (r.min[a] = Math.min(r.min[a], i)),
                  (r.max[a] = Math.max(r.max[a], i));
              }
            return r;
          }
          function l(e) {
          ...
          function c(e) {
            ...
            for (var t = new THREE.Vector3(), n = 0, r = e.count; n < r; n++)
          ...
          function p(e) {
            ...
            for (
              var t = e.clone(), n = new THREE.Vector3(), r = 0, o = t.count;
              r < o;
              r++
            )
              n.fromArray(t.array, 3 * r),
                0 === n.x && 0 === n.y && 0 === n.z ? n.setX(1) : n.normalize(),
                n.toArray(t.array, 3 * r);
          ...
          function d(e, t) {
            ...
            if (n !== e.byteLength) {
              ...
              if ((r.set(new Uint8Array(e)), 0 !== t))
                for (var o = e.byteLength; o < n; o++) r[o] = t;
              return r.buffer;
            }
            return e;
          }
          ...
          function m(e) {
            return R.buffers || (R.buffers = [{ byteLength: 0 }]), N.push(e), 0;
          }
          function v(e, t, n, o, a) {
            ...
            for (
              var s = f(o * e.itemSize * i),
                u = new DataView(new ArrayBuffer(s)),
                l = 0,
                c = n;
              c < n + o;
              c++
            )
              for (var p = 0; p < e.itemSize; p++) {
                ...
                t === r.FLOAT
                  ...
                  : t === r.UNSIGNED_SHORT
                  ? u.setUint16(l, d, !0)
                  : t === r.UNSIGNED_BYTE && u.setUint8(l, d),
                  (l += i);
              }
            var h = { buffer: m(u.buffer), byteOffset: P, byteLength: s };
            return (
              void 0 !== a && (h.target = a),
              a === r.ARRAY_BUFFER && (h.byteStride = e.itemSize * i),
              (P += s),
              ...
              new Promise(function (t) {
                ...
                n.readAsArrayBuffer(e),
                  (n.onloadend = function () {
                    ...
                    (P += e.byteLength),
                      R.bufferViews.push(r),
                      t(R.bufferViews.length - 1);
                  });
              })
            );
          }
          function y(e, t, o, a) {
            var i,
              s = { 1: "SCALAR", 2: "VEC2", 3: "VEC3", 4: "VEC4", 16: "MAT4" };
            if (e.array.constructor === Float32Array) i = r.FLOAT;
            else if (e.array.constructor === Uint32Array) i = r.UNSIGNED_INT;
            else if (e.array.constructor === Uint16Array) i = r.UNSIGNED_SHORT;
            else {
            ...
            if (
              ...
              var l = o + a,
                c =
                  t.drawRange.count === 1 / 0
                    ? e.count
                    : t.drawRange.start + t.drawRange.count;
              (o = Math.max(o, t.drawRange.start)),
                (a = Math.min(l, c) - o),
                a < 0 && (a = 0);
            }
            if (0 === a) return null;
            var p,
              f = u(e, o, a);
            void 0 !== t &&
              (p = e === t.index ? r.ELEMENT_ARRAY_BUFFER : r.ARRAY_BUFFER);
            var d = v(e, i, o, a, p),
              h = {
                bufferView: d.id,
          ...
          function b(e, t, r) {
            ...
            if (n.embedImages) {
              ...
              (u.width = e.width),
                (u.height = e.height),
                n.forcePowerOfTwoTextures &&
                  !l(e) &&
                  (console.warn(
                    "GLTFExporter: Resized non-power-of-two image.",
                    e
                  ),
                  (u.width = THREE.Math.floorPowerOfTwo(u.width)),
                  (u.height = THREE.Math.floorPowerOfTwo(u.height)));
              var c = u.getContext("2d");
              !0 === r && (c.translate(0, u.height), c.scale(1, -1)),
          ...
          function w(e) {
            ...
            var t = { sampler: E(e), source: b(e.image, e.format, e.flipY) };
            R.textures.push(t);
          ...
          function x(e) {
            ...
            if ((R.materials || (R.materials = []), e.isShaderMaterial))
              return (
                console.warn(
            ...
            if (
              (i(n, [1, 1, 1, 1]) ||
                (t.pbrMetallicRoughness.baseColorFactor = n),
              e.isMeshStandardMaterial
                ? ((t.pbrMetallicRoughness.metallicFactor = e.metalness),
                  (t.pbrMetallicRoughness.roughnessFactor = e.roughness))
                : e.isMeshBasicMaterial
                ? ((t.pbrMetallicRoughness.metallicFactor = 0),
                  (t.pbrMetallicRoughness.roughnessFactor = 0.9))
                : ((t.pbrMetallicRoughness.metallicFactor = 0.5),
                  (t.pbrMetallicRoughness.roughnessFactor = 0.5)),
              ...
              e.map &&
                (t.pbrMetallicRoughness.baseColorTexture = { index: w(e.map) }),
              e.isMeshBasicMaterial ||
              ...
              var r = e.emissive
                ...
                .toArray();
              i(r, [0, 0, 0]) || (t.emissiveFactor = r),
                e.emissiveMap &&
                  (t.emissiveTexture = { index: w(e.emissiveMap) });
            }
            e.normalMap &&
              ((t.normalTexture = { index: w(e.normalMap) }),
              -1 !== e.normalScale.x &&
                (e.normalScale.x !== e.normalScale.y &&
                  console.warn(
                    "THREE.GLTFExporter: Normal scale components are different, ignoring Y and exporting X."
                  ),
                (t.normalTexture.scale = e.normalScale.x))),
              e.aoMap &&
                ((t.occlusionTexture = { index: w(e.aoMap) }),
                1 !== e.aoMapIntensity &&
                  (t.occlusionTexture.strength = e.aoMapIntensity)),
              (e.transparent || e.alphaTest > 0) &&
                ((t.alphaMode = e.opacity < 1 ? "BLEND" : "MASK"),
                e.alphaTest > 0 &&
                  0.5 !== e.alphaTest &&
                  (t.alphaCutoff = e.alphaTest)),
              e.side === THREE.DoubleSide && (t.doubleSided = !0),
              "" !== e.name && (t.name = e.name),
              Object.keys(e.userData).length > 0 && (t.extras = h(e)),
              R.materials.push(t);
          ...
          function C(e) {
            var t,
              o = e.geometry;
            if (e.isLineSegments) t = r.LINES;
            else if (e.isLineLoop) t = r.LINE_LOOP;
            else if (e.isLine) t = r.LINE_STRIP;
            else if (e.isPoints) t = r.POINTS;
            else {
              if (!o.isBufferGeometry) {
                var a = new THREE.BufferGeometry();
                a.fromGeometry(o), (o = a);
              }
              e.drawMode === THREE.TriangleFanDrawMode
                ? (console.warn(
                    "GLTFExporter: TriangleFanDrawMode and wireframe incompatible."
                  ),
                  (t = r.TRIANGLE_FAN))
                : (t =
                    e.drawMode === THREE.TriangleStripDrawMode
            ...
            if (
              (void 0 !== d && o.addAttribute("normal", d),
            ...
            if (
              ...
              if (void 0 !== e.morphTargetDictionary)
                for (var _ in e.morphTargetDictionary)
                  C[e.morphTargetDictionary[_]] = _;
              for (var T = 0; T < e.morphTargetInfluences.length; ++T) {
                var O = {},
                  k = !1;
                for (var m in o.morphAttributes)
                  if ("position" === m || "normal" === m) {
                    for (
                      var v = o.morphAttributes[m][T],
                        S = o.attributes[m],
                        A = v.clone(),
                        I = 0,
                        M = v.count;
                    ...
                    k ||
                      ...
                      (k = !0));
                l.push(O),
                  E.push(e.morphTargetInfluences[T]),
                  void 0 !== e.morphTargetDictionary && w.push(C[T]);
              }
              (i.weights = E),
                w.length > 0 && ((i.extras = {}), (i.extras.targetNames = w));
            }
            ...
            if (null === o.index && N) {
              for (
                var L = [], T = 0, j = o.attributes.position.count;
                T < j;
                T++
              )
                L[T] = T;
            ...
            for (
              ...
              var V = { mode: t, attributes: s };
              P && (V.extras = P),
                l.length > 0 && (V.targets = l),
                null !== o.index &&
                  (V.indices = y(o.index, o, U[T].start, U[T].count));
          ...
          function _(e) {
            ...
            var t = e.isOrthographicCamera,
              n = { type: t ? "orthographic" : "perspective" };
            return (
              t
                ? (n.orthographic = {
                    xmag: 2 * e.right,
            ...
            for (var n = [], r = [], o = 0; o < e.tracks.length; ++o) {
              ...
              if (
                ("bones" === s.objectName &&
                  (u =
                    !0 === u.isSkinnedMesh
                      ? u.skeleton.getBoneByName(s.objectIndex)
                      : void 0),
                !u || !l)
              )
                return (
              ...
              if (l === a.morphTargetInfluences) {
                if (
                  1 !== u.morphTargetInfluences.length &&
                  void 0 !== s.propertyIndex
                ) {
                  console.warn(
                    'THREE.GLTFExporter: Skipping animation track "%s". Morph target keyframe tracks must target all available morph targets for the given mesh.',
                    i.name
                  );
                  continue;
                }
              ...
              i.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline
                ? ((p = "CUBICSPLINE"), (c /= 3))
                : (p =
                    i.getInterpolation() === THREE.InterpolateDiscrete
                      ? "STEP"
                      : "LINEAR"),
                r.push({
          ...
          function O(e) {
            ...
            for (
              var o = [], a = new Float32Array(16 * n.bones.length), i = 0;
              i < n.bones.length;
              ++i
            )
              o.push(F.get(n.bones[i])), n.boneInverses[i].toArray(a, 16 * i);
            return (
              void 0 === R.skins && (R.skins = []),
              R.skins.push({
          ...
          function k(e) {
            ...
            if (n.trs) {
              var r = e.quaternion.toArray(),
                ...
                a = e.scale.toArray();
              i(r, [0, 0, 0, 1]) || (t.rotation = r),
                i(o, [0, 0, 0]) || (t.translation = o),
                i(a, [1, 1, 1]) || (t.scale = a);
            } else
              e.updateMatrix(),
                i(e.matrix.elements, [
                  ...
                  0,
                  1,
                ]) || (t.matrix = e.matrix.elements);
            if (
              ("" !== e.name && (t.name = String(e.name)),
              e.userData &&
                Object.keys(e.userData).length > 0 &&
                (t.extras = h(e)),
          ...
          var M,
            R = { asset: { version: "2.0", generator: "THREE.GLTFExporter" } },
            P = 0,
            N = [],
            D = [],
            F = new Map(),
          ...
          !(function (e) {
            ...
            for (var t = [], r = 0; r < e.length; r++)
              e[r] instanceof THREE.Scene ? S(e[r]) : t.push(e[r]);
            t.length > 0 && A(t);
            for (var r = 0; r < L.length; ++r) O(L[r]);
            for (var r = 0; r < n.animations.length; ++r)
              T(n.animations[r], e[0]);
          })(e),
            Promise.all(D).then(function () {
              var e = new Blob(N, { type: "application/octet-stream" }),
                r = Object.keys(j);
              if (
                (r.length > 0 && (R.extensionsUsed = r),
  ...
  function (e, t, n) {
    ...
    function a(e, t) {
            ...
            : Object.keys(e).forEach(function (n) {
                "object" != typeof e[n]
                  ? void 0 !== T.registered[e[n]]
                    ? (t += n + "{" + T.registered[e[n]] + "}")
                    : (t += d(n) + ":" + h(n, e[n]) + ";")
                  : Array.isArray(e[n]) &&
                    "string" == typeof e[n][0] &&
                    void 0 === T.registered[e[n][0]]
      ...
      var w,
        ...
        C = t.key || "css",
        _ = p()(r);
      void 0 !== t.prefix && (x = { prefix: t.prefix });
      var T = { registered: {}, inserted: {}, nonce: t.nonce, key: C },
        O = new g(t);
      v && O.inject();
      var k = new l.a(x);
      ...
      var S,
        ...
        D = function () {
          var e = N.apply(this, arguments),
            t = C + "-" + S;
          return (
            void 0 === T.registered[t] && (T.registered[t] = A),
            i("." + t, e),
            t
          );
        },
        ...
        if (n) {
          ...
          for (var i in n)
            if (n.hasOwnProperty(i) && i !== u) {
              ...
              if ((o(c, i), E.hasOwnProperty(i))) E[i](e, l);
              else {
    ...
    function r(e, t) {
      ...
      return function () {
        for (var t = arguments.length, o = new Array(t), u = 0; u < t; u++)
          o[u] = arguments[u];
        return i && n === this && o.length === a.length && o.every(s)
          ? r
    ...
    function u(e, t, n, r) {
      ...
      x &&
        (k || u !== T.compositionStart
          ? u === T.compositionEnd && k && (l = k.getData())
          : (k = h.getPooled(r)));
  ...
  function (e, t, n) {
    ...
    var D = !1;
    C.canUseDOM &&
      (D = A("input") && (!document.documentMode || document.documentMode > 9));
    var F = {
      eventTypes: M,
  ...
  function (e, t, n) {
    ...
    var i = n(3),
      ...
      v = (n(0), n(38)),
      g = n(54),
      y = (n(4), { ImpureClass: 0, PureClass: 1, StatelessFunctional: 2 });
      ...
      (m.Mixin = {
        mountComponent: function (e, t, n, r) {
          ...
          null != t
            ...
            (null == i || (i === w.svg && "foreignobject" === f)) &&
              (i = w.html),
            i === w.html &&
              ("svg" === this._tag
                ? (i = w.svg)
                : "math" === this._tag && (i = w.mathml)),
            ...
            if (!t.hasOwnProperty(r) && e.hasOwnProperty(r) && null != e[r])
              if ("style" === r) {
                ...
                V.hasOwnProperty(r)
                  ? e[r] && j(this, r)
                  : h(this._tag, e)
                  ? W.hasOwnProperty(r) || C.deleteValueForAttribute(H(this), r)
          ...
          for (r in t) {
            ...
            if (t.hasOwnProperty(r) && u !== l && (null != u || null != l))
              if ("style" === r)
                ...
                W.hasOwnProperty(r) || C.setValueForAttribute(H(this), r, u);
        ...
        return (
          (n.handleLifecycle = function (e, t, n) {
            ...
            a.props[e] && (r = a.props)[e].apply(r, n),
              this.props[e] && this.props[e]((0, s.findDOMNode)(this));
          }),
          (n.render = function () {
            var e = this.props,
              t = e.children,
